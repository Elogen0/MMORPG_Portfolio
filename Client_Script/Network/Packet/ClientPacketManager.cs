...
class PacketManager
{
	...
	{		
		...
		_onRecv.Add((ushort)MsgId.SSwapSlot, MakePacket<S_SwapSlot>);
		_handler.Add((ushort)MsgId.SSwapSlot, PacketHandler.S_SwapSlotHandler);		
		...
		_onRecv.Add((ushort)MsgId.SQuestStatus, MakePacket<S_QuestStatus>);
		_handler.Add((ushort)MsgId.SQuestStatus, PacketHandler.S_QuestStatusHandler);		
		...
		_onRecv.Add((ushort)MsgId.SAnimParameter, MakePacket<S_AnimParameter>);
		_handler.Add((ushort)MsgId.SAnimParameter, PacketHandler.S_AnimParameterHandler);		
		_onRecv.Add((ushort)MsgId.SShopTrade, MakePacket<S_ShopTrade>);
		_handler.Add((ushort)MsgId.SShopTrade, PacketHandler.S_ShopTradeHandler);		
